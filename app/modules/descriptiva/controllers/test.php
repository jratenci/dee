...
class Test extends Controller {
   ...
   $this->unit->run( $this->descriptiva_model->quartil2( Array(Array(2, 5, 3, 6, 7, 4, 9),Array(2, 5, 3, 4, 6, 7, 1, 9))), Array(6,4.5), "test quartil 2"  );
        echo $this->unit->report();
   }
   
   public function quartil3(){ //test cuartil 3
   $this->unit->run( $this->descriptiva_model->quartil3( Array(Array(2, 5, 3, 6, 7, 4, 9),Array(2, 5, 3, 4, 6, 7, 1, 9))), Array(7,6.5), "test quartil 3"  );
        echo $this->unit->report();
   }
...
//   print_r($this->descriptiva_model->cv( Array(Array(3.0,5.8,5.6,4.8,5.1,3.6,5.5,4.7,5.7,5.0,5.9,5.7,4.4,5.4,4.2,5.3),Array(1,2,3,4,5))));
   ...
   $this->unit->run( $this->descriptiva_model->coasimetria( Array(Array(3,4,5,2,3,4,5,6,4,7))), Array(0,359543), "test coeficiente de asimetria"  );
//   print_r($this->descriptiva_model->cv( Array(Array(3.0,5.8,5.6,4.8,5.1,3.6,5.5,4.7,5.7,5.0,5.9,5.7,4.4,5.4,4.2,5.3),Array(1,2,3,4,5))));
   echo $this->unit->report();
   }
   public function rangointercuartil(){ //test varianza
   $this->unit->run( $this->descriptiva_model->rangointercuartil( Array(Array(1,2,3,4,5),Array(2, 5, 3, 4, 6, 7, 1, 9))), Array(4,4), "test coeficiente de asimetria"  );
//   print_r($this->descriptiva_model->cv( Array(Array(3.0,5.8,5.6,4.8,5.1,3.6,5.5,4.7,5.7,5.0,5.9,5.7,4.4,5.4,4.2,5.3),Array(1,2,3,4,5))));
   echo $this->unit->report();
   }
